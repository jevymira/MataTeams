...
{
    /// <inheritdoc />
    public partial class InitialMigrationPostDbSwap : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsFacultyOrStaff = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SkillUser", x => new { x.SkillsId, x.UserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectRoleSkill", x => new { x.ProjectRoleId, x.SkillsId });
                    table.ForeignKey(
                        name: "FK_ProjectRoleSkill_ProjectRoles_ProjectRoleId",
                        column: x => x.ProjectRoleId,
                        principalTable: "ProjectRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectRoleSkill_Skills_SkillsId",
                        column: x => x.SkillsId,
                        principalTable: "Skills",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeamMembershipRequests", x => x.Id);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TeamMembershipRequests_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectRoleSkill_SkillsId",
                table: "ProjectRoleSkill",
                column: "SkillsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamMembers_ProjectRoleId",
                table: "TeamMembers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamMembershipRequests_ProjectRoleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamMembershipRequests_UserId",
                table: "TeamMembershipRequests",
                column: "UserId");

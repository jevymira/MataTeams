...
namespace Teams.Infrastructure.Migrations
{
    ...
    [Migration("20251002152758_AddProjectRolesAndSkills")]
    partial class AddProjectRolesAndSkills
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Teams.Domain.Aggregates.ProjectAggregate.ProjectRoleSkill", b =>
                {
                    ...
                    b.HasKey("ProjectRoleId", "SkillId");
            ...
            modelBuilder.Entity("Teams.Domain.Aggregates.ProjectAggregate.ProjectRole", b =>
                {
                    ...
                    b.HasOne("Teams.Domain.SharedKernel.Role", "Role")
                        .WithOne()
                        .HasForeignKey("Teams.Domain.Aggregates.ProjectAggregate.ProjectRole", "RoleId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Teams.Domain.Aggregates.ProjectAggregate.ProjectRoleSkill", b =>
                {
                    ...
                    b.HasOne("Teams.Domain.SharedKernel.Skill", "Skill")
                        .WithOne()
                        .HasForeignKey("Teams.Domain.Aggregates.ProjectAggregate.ProjectRoleSkill", "SkillId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
